...
# -D on both .so files), so this is a "stay consistent with
...
# tools independent and unregressed. Needs both AST_LIBS (reproject
...
# gaussft_mod/commonbeam_mod's own split) against dirty AMP/PHA
