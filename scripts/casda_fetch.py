...
def main() -> None:
    ...
    casda = Casda()
    authenticated = casda.login(username=args.username, store_password=True)
        ...
        if all_already_present and args.if_exists != "refetch":
            ...
            try:
                print(f"  Requesting a cutout from CASDA -- this stages "
                      ...
                      f"taken upwards of a minute per observation; no "
                      f"further output is printed here until that's done.")
