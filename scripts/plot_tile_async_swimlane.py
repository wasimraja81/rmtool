...
Example:
  ~/venv/rmtool/bin/python scripts/plot_tile_async_swimlane.py \
...
THREAD_CPU_RE = re.compile(
    ...
    # for every smaller value, a pre-existing gap this project's
...
#   zero plotted intervals before this fix, a pre-existing gap,
...
#   tid, all sharing the identical team-elapsed dur_ms for that
        ...
        for line in f:
            ...
            if cat == "tile_compute":
                ...
                if mgs:
                    ...
                    # tile fits in one VRAM sub-block) logs 'gpu send'/
...
def draw_io_throughput_panel(
    ...
    for iv in io_intervals:
        ...
        # that floor here, a short interval (e.g. the last, smaller
