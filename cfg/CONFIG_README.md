...
`reproject_cubes`, `convolve_cubes`, and `match_cubes` (see
[docs/user/APP_REFERENCE.md](../docs/user/APP_REFERENCE.md)) are
separate standalone tools with their own similar-but-separate KEY=VALUE
parsers (deliberately
