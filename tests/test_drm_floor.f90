program test_drm_floor
   ...
   !! fit needed that carrier-resolving margin). After T3's
   ...
   !! is exactly why that gate exists. (The coarse-but-
   !! IN-contract regime -- resolution-adequate grids far below the old
   !! carrier bound, e.g. fwhm/2 at lsq_ref=0 -- is covered
   ...
   !! evidence the default-2 carries safety margin rather than
   !! sitting on the edge.
   !!
   ...
   !! chi0 error from under-sampling shows up in the reported
   ...
   ! below RESOLUTION Nyquist, out of the T3b input contract
