...
def main() -> None:
    ...
    # band 2 (docs/dev/MULTI_BAND_TOMOGRAPHY_PLAN.md T15): for an
    # END-TO-END preprocessing test -- reproject_cubes/convolve_cubes/
    # match_cubes fixing mismatches and rm_synthesis then
    ...
    # mismatch; both Q and U written since a preprocessing
    ...
    # beam, band 2 at a different 20" beam -- convolve_cubes
    # must smooth band 1 up to the common target, not a no-op.
