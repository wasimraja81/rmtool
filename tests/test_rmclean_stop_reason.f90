program test_rmclean_stop_reason
   ...
   !! (docs/dev/RMCLEAN_INTEGRATION_PLAN.md T8 -- replaced the old single
   ...
   !! confirms the ORIGINAL call form (trace arguments omitted,
   ...
   ! sidelobe structure rather than statistical noise, which
   ...
   ! random_number) gives a reproducible noise sigma.
