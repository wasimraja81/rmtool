program thesis_scenario_rmclean
   ...
   ! trajectory closely). rm_drm_oversample=15 (comfortably above the bare
   ! 2-point Nyquist minimum, since peak_interp_parabolic's local quadratic
   ! fit needs several samples per cycle, not just two) was empirically
   ! confirmed sufficient by that same convergence check.
