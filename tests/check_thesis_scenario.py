...
def main():
    ...
    # documented limitation (see Sec 10 addendum / this ticket's
    # Evidence section), not something this check papers over. What *is*
    # checked: both expected positions still carry an elevated
    ...
    # enough that a relative comparison isn't meaningful here. Both
