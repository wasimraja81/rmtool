program test_matched_filter_refine
   !! docs/dev/RMCLEAN_INTEGRATION_PLAN.md tickets T3 + T3c: validates
   ...
   !!     criterion picks must land on truth.
...
contains
   ...
   subroutine run_tier_mechanics(fwhm_rm_in, all_pass_io)
      ...
      !! samples/fwhm), even a clean, noiseless single
      ...
      !! compute_rmsf_fwhm's own bug made "fwhm/2" mean
