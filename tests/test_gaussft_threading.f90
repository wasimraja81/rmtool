program test_gaussft_threading
   ...
   !! enough that OMP_NUM_THREADS>1 engages multiple threads
   ...
   ! of test T23's own regression uses -- a plane in flight always
   ...
   ! bit-identical -- determinism, not "close enough".
