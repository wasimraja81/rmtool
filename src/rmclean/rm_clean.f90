...
chelp-
     ...
     -                    ClnMAP_RMamp, ClnMAP_RMpha, ofac,
...
!      real*4     DtyBEAM_reRM(maxrm,maxrm), DtyBEAM_imRM(maxrm,maxrm)
         ...
         real*4     ClnFlux(nrm), ResiAmp(nrm)
         real*4     ResiQ(nrm), ResiU(nrm),
...
!            endif
!         enddo
            !write(*,*)"Phase now: ",phase_val*180.0/3.141592
            !phase_val = 0.0
            !write(*,*)"Phase now: ",phase_val*180.0/3.141592
...
!         do i = 1,nrm
!            write(*,*)"I am heree.... i,nbeams,maxrm: ",i,nbeams,maxrm
!            DtyBEAM_reRM(nbeams,i) = re_beam(i)
!            DtyBEAM_imRM(nbeams,i) = im_beam(i)
!            write(*,*)"I am heree.... i,nbeams,maxrm: ",i,nbeams,maxrm
!         enddo
            bm_indx = nbeams
 ...
 1999       continue
            do i = 1,nrm
!            beam_now(i) = sqrt(DtyBEAM_reRM(bm_indx,i)**2 +
!     -                         DtyBEAM_imRM(bm_indx,i)**2)
            ...
            if(dev.gt.thresh*rms_MAP.and.iter.lt.niter)then
               ...
               do i = 1,nrm
!                    ResiQ(i) = ResiQ(i) - (fracQ*DtyBEAM_reRM(bm_indx,i)
!     -                                  - fracU*DtyBEAM_imRM(bm_indx,i))
!                    ResiU(i) = ResiU(i) - (fracU*DtyBEAM_reRM(bm_indx,i)
!     -                                  + fracQ*DtyBEAM_imRM(bm_indx,i))
!
                  !ResiQ(i) = ResiQ(i) - frac*DtyBEAM_reRM(bm_indx,i)
                  !ResiU(i) = ResiU(i) - frac*DtyBEAM_imRM(bm_indx,i)
