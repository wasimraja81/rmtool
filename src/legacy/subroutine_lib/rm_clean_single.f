chelp+
      ...
      ! 
      ! Cleans either Q or U (separately). 
      ! 
...
chelp-
      ...
      subroutine rm_clean_single(L_sq, nchan, W, RM_in, 
     -                    DtyMAP_AMP, DtyMAP_PHA, 
     -                    maxrm, nrm, 
     -                    niter, gain, thresh,
     -                    ClnMAP_AMP, ClnMAP_PHA, 
     -                    ofac, interp_type) 
      ...
      real*4      L_sq(*), W(*), RM_in(*) 
      real*4      DtyMAP_AMP(*), DtyMAP_PHA(*) 
      real*4      ClnMAP_AMP(*), ClnMAP_PHA(*)
...
1001             continue
                 over = .true. 
                 write(*,*)"Done Enough!"
                 write(*,*)"Stopping clean..."
         endif
      enddo
      ! And Restore the Cleaned Map: 
      do i = 1,nrm
